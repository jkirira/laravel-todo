        ...
        <div class="left max-h-[500px] ">
            <div>
                <form>
                    ...
                    <button type="submit" class="p-2 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Search</button>
                </form>
            </div>

            <div class="output border-2 border-gray-200 max-h-[800px] overflow-scroll mt-4" >
                <div v-if="posts">
...
export default {
    ...
    methods: {
        ...
        addPost(e){
            ...
            axios.post(URL, this.new_post)
                .then((response) => {
                    ...
                    this.message_class = "border border-green-200 text-green-200"
                 }).catch((err) => {
                    console.error('Error', err)
                })
        },
        ...
        deletePost(p){
            let URL = 'http://laravel-todo.appp/posts/delete/'
            axios.post(URL, p.id)
                .then((response)=> {
